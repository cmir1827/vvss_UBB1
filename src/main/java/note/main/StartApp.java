...
public class StartApp {
	...
	public static void main(String[] args)  throws ClasaException {
		...
		NoteController ctrl = new NoteController();
			...
			ctrl.readElevi("src/main/java/elevi.txt");//ctrl.readElevi(args[0]);
			ctrl.readNote("src/main/java/note.txt");//ctrl.readNote(args[1]);
				...
				try {
					...
					switch (option) {
						case 1:
							...
							double nr_matricol = scan.nextDouble();
							System.out.println("Materia: ");
							String materia = scan.next();
							System.out.println("Nota: ");
							double nota = scan.nextDouble();
							ctrl.addNota(new Nota(nr_matricol,materia,nota));
						case 2:
