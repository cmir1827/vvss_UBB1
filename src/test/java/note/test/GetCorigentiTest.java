...
public class GetCorigentiTest {
	...
	public void test4() throws ClasaException {
		...
		ctrl.creeazaClasa(ctrl.getElevi(), ctrl.getNote());
		List<Corigent> corigenti = ctrl.getCorigenti();
//		System.out.println(corigenti.get(1).getNrMaterii()+1);
//		System.out.println(corigenti.get(0).getNrMaterii());
		assertEquals(corigenti.get(1).getNrMaterii()+1, corigenti.get(0).getNrMaterii()+2);
	}
