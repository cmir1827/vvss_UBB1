...
private NoteController ctrl;
	...
	public void prepareData() throws ClasaException {
		Elev e1 = new Elev(1, "Elev1");
		Elev e2 = new Elev(2, "Elev2");
		Elev e3 = new Elev(3, "Elev3");
		Elev e4 = new Elev(4, "Elev4");
		Elev e5 = new Elev(5, "Elev5");
		ctrl.addElev(e1);
		ctrl.addElev(e2);
		ctrl.addElev(e3);
		ctrl.addElev(e4);
		...
		Nota n9 = new Nota(3,"Materie2", 7);
		Nota n10 = new Nota(3,"Materie1", 6);
		Nota n11 = new Nota(3,"Materie1", 2);
		Nota n12 = new Nota(3,"Materie2", 8);

		Nota n13 = new Nota(4,"Materie1", 1);
		Nota n14 = new Nota(4,"Materie2", 10);
		Nota n15 = new Nota(4,"Materie2", 9);
		Nota n16 = new Nota(4,"Materie1", 5);

		Nota n17 = new Nota(5,"Materie1", 2);
		Nota n18 = new Nota(5,"Materie2", 3);
		Nota n19 = new Nota(5,"Materie1", 4);
		Nota n20 = new Nota(5,"Materie2", 5);
